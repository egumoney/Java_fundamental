...
public class PrimeNum_3th {
	...
	public static void main(String[] args) {
		...
		//	prime[cnt] = cnt + 1;
			...
			if (cnt == 0) prime[cnt] = 0;// prime[i]= primeCheck(i,prime);
			if (prime[cnt] != 2 && prime[cnt] % 2 == 0)	prime[cnt] = 0;
			if (prime[cnt] != 3 && prime[cnt] % 3 == 0) prime[cnt] = 0;
			if (prime[cnt] != 5 && prime[cnt] % 5 == 0) prime[cnt] = 0;
			if (prime[cnt] != 7 && prime[cnt] % 7 == 0) prime[cnt] = 0;
			if (prime[cnt] != 9 && prime[cnt] % 9 == 0) prime[cnt] = 0;
			System.out.print(prime[cnt] + "\t"); //if (cnt % 9 == 0)System.out.println(); //이경우 1 자리는 바로 개행 한다 . 
		}
